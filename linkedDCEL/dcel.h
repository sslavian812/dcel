...
struct LinkedDcel
{
    ...
    LinkedDcel()
    {
        vertices.push_back(new Vertex(NULL, NULL, 0.0, 0.0)); // infinite vertex
    ...
    Edge* getNearest(Line* line)
    {
        ...
        Edge* cur_edge = vertices[0]->incidentEdge;
    ...
    {
        Edge* e1 = new Edge(vertices[0], line1);
        edges.push_back(e1);
        Edge* e2 = new Edge(vertices[0], line2);
        edges.push_back(e2);
    ...
    void addSecond(Line* line1, Line* line2)
    {
        ...
        */
        ...
        Edge* new_e1 = new Edge(vertices[0], line1);
        ...
        edges.push_back(new_e1);
        new_e2 = new Edge(vertices[0], line2);
        edges.push_back(new_e2);
    ...
    bool addLine(double a, double b, double c)
    {
        ...
        else
        {
            ...
            Edge* end;
            Edge* in;
            Vertex* start_vertex = vertices[0];

            begin = getNearest(line1);
            end = begin->prev;

            if(begin->origin != vertices[0])
                std::swap(begin, end);
